...
using PetStore.Api.Authentication;
using PetStore.Api.Filters;
using PetStore.Api.OpenApi;
using PetStore.Api.Formatters;
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services
                .AddSwaggerGen(c =>
                {
                    ...
                    c.SwaggerDoc("1.0.27-SNAPSHOT", new OpenApiInfo
                    {
                        Title = "Swagger Petstore - OpenAPI 3.0",
                        Description = "Swagger Petstore - OpenAPI 3.0 (ASP.NET Core 8.0)",
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwagger(c =>
                ...
                .UseSwaggerUI(c =>
                {
                    ...
                    c.SwaggerEndpoint("/openapi/1.0.27-SNAPSHOT/openapi.json", "Swagger Petstore - OpenAPI 3.0");
